...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var map: [[Tile]] = [[Tile]]()
    var obstacles: [GKPolygonObstacle] = [GKPolygonObstacle]()
    
    var player = Player()
    let enemy = Enemy(x: 5, y: 3)
    ...
    func buildMap(name: String) -> [[Tile]] {
        ...
        self.obstacles = SKNode.obstaclesFromNodePhysicsBodies(obstacleNodes)
